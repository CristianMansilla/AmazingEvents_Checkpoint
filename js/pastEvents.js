...
//Función anterior
/* function paintDom(dataAE){
    let bodyPastEvents = ``;
    for(let i=0; i<dataAE.eventos.length; i++){
        if(dataAE.fechaActual>dataAE.eventos[i].date){
            bodyPastEvents += `
            <div class="col">
                <div class="card h-210">
                    <img src="${dataAE.eventos[i].image}" class="card-img-top" alt="">
                    <div class="card-body d-flex flex-column align-items-center">
                        <div>
                            <h5 class="card-title">${dataAE.eventos[i].name}</h5>
                            <p class="card-text">${dataAE.eventos[i].description}</p>
                        </div>
                        <div class="price d-flex justify-content-between align-items-start">
                            <p>Price $${dataAE.eventos[i].price}</p>
                            <a href="../pages/details.html"><button class="button">See more</button></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $cardsContainer.innerHTML = bodyPastEvents;
} */