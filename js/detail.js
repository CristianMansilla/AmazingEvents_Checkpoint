...
const titleCardDetail = localStorage.getItem("title");
// console.log(titleCardDetail)
const detailsCards = document.getElementById("details-container");
    ...
    data.events.forEach(event => {
        if(event.name.toLowerCase().replaceAll(" ", "-").includes(titleCardDetail)){
            ...
            <div class="details__image">
                <img src="../assets/503.jpg" alt="X">
            </div>
            <div class="details__text">
                <div>
                    <h5>${event.name}</h5>
                    <p class="descriptionDetails">${event.description}</p>
